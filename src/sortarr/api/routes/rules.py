...
from sortarr.api.models import RoutingRuleCreate, RoutingRuleUpdate, RoutingRuleResponse
from sortarr.db.repository import pipeline as repo

log = logging.getLogger("sortarr.api.rules")
router = APIRouter()
