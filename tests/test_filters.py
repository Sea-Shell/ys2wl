...
class TestSelectorFilter:
    def test_no_selectors_passes(self):
        ...
        result = selector_filter(activity, "Channel", [], "AND")
        assert result.passed
    ...
    def test_title_contains_match(self):
        ...
        selectors = [
            PipelineSelector(field="title", operator="contains", pattern="python")
        ]
        result = selector_filter(activity, "Channel", selectors, "AND")
        assert result.passed
    ...
    def test_channel_title_match(self):
        ...
        selectors = [
            PipelineSelector(
                field="channel_title", operator="contains", pattern="Music"
            )
        ]
        result = selector_filter(activity, "Music Channel", selectors, "AND")
        assert result.passed
    ...
    def test_selector_and_mode_one_fails(self):
        ...
        selectors = [
            PipelineSelector(field="title", operator="contains", pattern="python"),
            PipelineSelector(field="title", operator="contains", pattern="golang"),
        ]
        result = selector_filter(activity, "Channel", selectors, "AND")
        assert not result.passed
    ...
    def test_selector_or_mode_any_match(self):
        ...
        result = selector_filter(activity, "Channel", selectors)
        assert result.passed
    ...
    def test_regex_selector(self):
        ...
        selectors = [
            PipelineSelector(field="title", operator="regex", pattern=".*[Tt]utorial.*")
        ]
        result = selector_filter(activity, "Channel", selectors, "AND")
        assert result.passed
    ...
    def test_equals_selector(self):
        ...
        selectors = [
            PipelineSelector(field="title", operator="equals", pattern="exact title")
        ]
        result = selector_filter(activity, "Channel", selectors, "AND")
        assert result.passed
    ...
    def test_description_field(self):
        ...
        activity = Activity(
            video_id="v1",
            title="Video",
            description="Check out my description",
            published_at="now",
            video_type="upload",
        )
        selectors = [
            PipelineSelector(
                field="description", operator="contains", pattern="description"
            )
        ]
        result = selector_filter(activity, "Channel", selectors, "AND")
        assert result.passed
